            ...
            <AnimatePresence mode="wait">
              {state.succeeded ? (
                ...
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                  className="flex min-h-[400px] flex-col items-center justify-center gap-4 border border-border p-10 text-center"
                >
